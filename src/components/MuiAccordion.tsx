        ...
        <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
            ...
            <AccordionDetails>
                <Typography>
                    ...
                    elit. Quis, laboriosam ipsa non officiis incidunt 
                    facere maiores tempore reprehenderit voluptatem. 
                    Ratione ipsam quod cum quisquam consectetur maiores
                    asperiores nihil beatae placeat.
                </Typography>
            </AccordionDetails>
